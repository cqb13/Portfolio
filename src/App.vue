...
<template>
  <header class="flex justify-between fixed w-screen px-10 pt-10">
    <div class="flex flex-col items-start">
      <a
        class="font-heading font-bold hover:bg-black hover:text-white transition-all duration-300 m-0 px-2 tracking-wider ease-in-out"
      ...
      <a
        class="font-heading font-bold hover:bg-black hover:text-white transition-all duration-300 m-0 px-2 tracking-wider ease-in-out"
        href="https://www.linkedin.com/in/maksim-straus/"
        target="_blank"
        >LinkedIn</a
      >
    </div>
    <div v-if="isCenterDivVisible" class="flex flex-col gap-0">
